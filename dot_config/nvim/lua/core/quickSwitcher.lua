...
-- FIX: doesn't work if file name are similar, make it absolute search ex: keymaps.lua vs fzf-keymaps.lua
-- TODO: show/highlightword the char which is gonna trigger, to make user stop typing more
